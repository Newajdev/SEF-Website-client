        ...
        <div className='py-20'>
            ...
            <div className='grid grid-cols-3 gap-6'>
                <div className='p-6 bg-[#edf8f0] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/247support.png' width={500} height={500} alt='24/7 Online Support' />
                ...
                <div className='p-6 bg-[#f8e6db] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/lifetimesupport.png' width={500} height={500} alt='Lifetime Support' />
                ...
                <div className='p-6 bg-[#edf8f0] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/specialclass.png' width={500} height={500} alt='Freelancing Special Class' />
                ...
                <div className='p-6 bg-[#f8e6db] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/labsupport.png' width={500} height={500} alt='Practice Lab Support' />
                ...
                <div className='p-6 bg-[#edf8f0] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/reviewclass.png' width={500} height={500} alt='Review Class' />
                ...
                <div className='p-6 bg-[#f8e6db] rounded-2xl shadow-sm text-[#00280B]'>
                    <Image className="h-24 w-24" src='/asset/recordedvideo.png' width={500} height={5000} alt='Class Record Videos' />
