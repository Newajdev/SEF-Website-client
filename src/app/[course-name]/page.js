...
const courseData = {
  "graphics-design": {
    ...
    description:
      "Master Adobe Photoshop, Illustrator, and InDesign to create stunning visuals.",
    fullDescription:
      "Transform your creative vision into professional designs. This comprehensive course covers everything from fundamental design principles to advanced techniques in Adobe Creative Suite. Learn to create logos, brand identities, marketing materials, and digital artwork that stands out.",
    ...
    modules: [
      {
        ...
        description:
          "Understanding design principles, color theory, and visual communication",
      },
      {
        title: "Photoshop Mastery",
        description:
          "Advanced photo editing, manipulation, and digital painting techniques",
      },
      {
        title: "Illustrator Basics",
        description:
          "Vector graphics, logo design, and scalable artwork creation",
      },
      {
        title: "Logo Design",
        description: "Creating memorable logos and brand identities",
      },
      {
        title: "Branding Identity",
        description: "Complete brand identity design and application",
      },
    ],
    forWhom:
      "Beginners interested in design, marketing professionals, freelancers, and entrepreneurs looking to create their own branding.",
    careerOutcomes: [
      "Graphic Designer",
  ...
  "t-shirt-design": {
    name: "T-Shirt Design",
    description:
      "Learn print-on-demand strategies and create best-selling t-shirt designs.",
    fullDescription:
      "Master the art and business of t-shirt design. Learn specialized techniques for print-on-demand businesses, understand fabric constraints, color separation, and trendy aesthetics to launch your own apparel line.",
    ...
    modules: [
      {
        title: "Typography for Tees",
        description:
          "Text design that works on fabric and appeals to customers",
      },
      {
        title: "Vector Art",
        description: "Creating scalable designs perfect for printing",
      },
      {
        title: "Print Preparation",
        description: "Color separation, file formats, and print-ready artwork",
      },
      {
        title: "Market Research",
        description: "Finding profitable niches and trending designs",
      },
      {
        title: "POD Platforms",
        description:
          "Setting up on platforms like Redbubble, Teespring, and more",
      },
    ],
    forWhom:
      "Aspiring apparel designers, entrepreneurs wanting to start a t-shirt business, graphic designers looking to expand their skills.",
    careerOutcomes: [
      "T-Shirt Designer",
      "POD Business Owner",
      "Apparel Designer",
  ...
  "digital-marketing": {
    ...
    fullDescription:
      "Develop comprehensive strategies for SEO, social media, and content marketing. Learn to analyze data and optimize campaigns for maximum ROI. Master the tools and techniques used by top digital marketers.",
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Building and managing effective social media campaigns",
      },
      {
        title: "Content Marketing",
        description: "Creating content that engages and converts",
      },
      {
        title: "PPC Advertising",
        description:
          "Google Ads, Facebook Ads, and paid advertising strategies",
      },
      {
        title: "Analytics",
        description: "Data analysis, reporting, and campaign optimization",
      },
    ],
    forWhom:
      "Marketing professionals, business owners, content creators, and anyone wanting to grow their online presence.",
    careerOutcomes: [
  ...
  "wordpress-development": {
    ...
    fullDescription:
      "Build custom, responsive websites without writing complex code. Master theme customization, plugin integration, and e-commerce solutions with WooCommerce. Create professional websites for clients or your own business.",
    ...
    modules: [
      {
        title: "WP Installation",
        description: "Setting up WordPress locally and on hosting servers",
      },
      {
        title: "Theme Customization",
        description: "Customizing themes and creating child themes",
      },
      {
        title: "Elementor Page Builder",
        description: "Building beautiful pages with drag-and-drop",
      },
      {
        title: "WooCommerce",
        description: "Creating fully functional e-commerce stores",
      },
      {
        title: "Site Optimization",
        description: "Speed optimization, SEO, and performance tuning",
      },
    ],
    forWhom:
      "Beginners wanting to build websites, freelancers, entrepreneurs, and small business owners.",
    careerOutcomes: [
      "WordPress Developer",
      "Web Developer",
  ...
  "frontend-development": {
    ...
    description:
      "Become a frontend engineer with React, Next.js, and modern CSS.",
    fullDescription:
      "Master modern frontend development with React, Next.js, and Tailwind CSS. Learn to build fast, responsive, and interactive web applications. From basics to advanced concepts, this course prepares you for a career in frontend development.",
    ...
    modules: [
      {
        title: "HTML/CSS/JS",
        description: "Fundamentals of web development and modern JavaScript",
      },
      {
        title: "React Basics",
        description: "Component-based development and React hooks",
      },
      {
    ...
    forWhom:
      "Aspiring developers, career changers, and anyone wanting to build modern web applications.",
    careerOutcomes: [
      "Frontend Developer",
      "React Developer",
      "Web Developer",
...
export default function CoursePage() {
  ...
  const courseFeatures = [
    ...
    },
    {
      ...
      desc: "Build a portfolio while you learn",
    },
    {
      icon: <FaUsers />,
      title: "Mentor Support",
      desc: "Get personalized help from industry experts",
    },
    {
      icon: <FaCertificate />,
      title: "Certification",
      desc: "Earn a recognized certificate upon completion",
    },
    {
      icon: <FaBriefcase />,
      title: "Career Guidance",
      desc: "Resume building and job placement assistance",
    },
  ];
              ...
              <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {course.careerOutcomes.map((outcome, idx) => (
                    <span
                      key={idx}
                      className="px-4 py-2 bg-white rounded-full text-gray-800 font-semibold shadow-sm"
                    >
                      {outcome}
                    </span>
                  ))}
